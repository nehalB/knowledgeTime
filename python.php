        ...
        <div class="page-title section lb">
            <div class="container">
                ...
                <div class="title-area pull-left">
                    <h2>Python Programming <small>Python is high level programming language with the feature of object oriented programming.</small></h2>
                </div><!-- /.pull-right -->
                </div><!-- end clearfix -->
            </div>
        </div><!-- end page-title -->
                    ...
                    <div class="sidebar course-sidebar col-md-4 col-sm-12">
                        <div class="widget clearfix">
                            <div class="post-media">
                                <div class="entry">
                                    <img src="upload/python1.png" alt="" class="img-responsive">
                                </div>
                            </div><!-- end media -->
                            <hr>
                    ...
                    <div class="content col-md-8 col-sm-12">
                        <div class="course-list normal-list">
                            <div class="video-wrapper course-widget clearfix">
                                <div class="post-media">
                                    <video class="videoplayer" poster="upload/python1
                                    .png" controls preload="none">
                                ...
                                <div class="widget-title clearfix">
                                    ...
                                    <hr>
                                    <p>Python is high level programming language with the feature of object oriented programming.  Python supports modules and packages, which encourages program modularity and code reuse.</p>
                                    <p>The course involves the fundamentals of python programming. Data structures, databases etc. The course involves more examples, which helps you to understand the programming concepts much better. Passionate programmers show you how to build small applications using the python programming concepts. Industry experts demonstrates few applications.</p> 
                                    <p>Tune to the next version of python programming for the Web Applications Development, Graphical User Interfaces and many more. </p>
                                </div><!-- end title -->
