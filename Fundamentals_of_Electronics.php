            ...
            <nav class="mobile-menu-container mobile-effect">
               <ul class="nav navbar-nav">
                 ...
                 <li  class="menu-item menu-item-type-custom menu-item-object-custom current-menu-ancestor menu-item-has-children drop_to_right multicolumn">
                  ...
                  </div></t></b></p></form></div></div></div></div></aside></p></form></div></div></div></ul></nav></div></div></div></div></header></div></div>
    ...
    ********************************************** -->
    ...
    <div id="wrapper">
        <div class="page-title section lb">
            <div class="container">
                ...
                <div class="title-area pull-left">
                    <h2>Fundamentals of Electronics </h2>
                </div><!-- /.pull-right -->
                </div><!-- end clearfix -->
            </div>
        </div><!-- end page-title -->
        ...
        <div class="section">
            <div class="container">
                <div class="row">
                    <div class="sidebar course-sidebar col-md-4 col-sm-12">
                        <div class="widget clearfix">
                            ...
                            <hr>
                            <a href="#" class="btn btn-default btn-block">Join the Course</a>
                        </div><!-- end widget -->
                        ...
                        <div class="widget clearfix">
                            <div class="sidebar-course-carousel owl-carousel owl-theme custom-list">
                                <div class="carousel-item">
                                    <div class="video-wrapper clearfix">
                                        ...
                                        <div class="widget-title clearfix">
                                            <div class="pull-left">
                                                <h3><a href="course-single.html">Learn English in 20 Days</a></h3>
                                                <a href="member-profile.html" class="readmore">Michael Denson</a>
                                            </div>
                                ...
                                <div class="carousel-item">
                                    <div class="video-wrapper clearfix">
                                        ...
                                        <div class="widget-title clearfix">
                                            <div class="pull-left">
                                                <h3><a href="course-single.html">Get HTML Package Service</a></h3>
                            ...
                            <div class="video-wrapper course-widget clearfix">
                                <div class="post-media">
                                    <video class="videoplayer" poster="upload/course_01.png" controls preload="none">
                                        ...
                                        <source type="video/webm" src="https://0.s3.envato.com/h264-video-previews/ec34ad1d-cba5-43a6-a1d0-a537b10e5879/759078.webm" />
                                        <!-- Ogg/Vorbis for older Firefox and Opera versions -->
                                        <source type="video/ogg" src="https://0.s3.envato.com/h264-video-previews/ec34ad1d-cba5-43a6-a1d0-a537b10e5879/759078.ogv" />
                                ...
                                <div class="widget-title clearfix">
                                    ...
                                    <hr>
                                    <p>In this course you will study basics of semiconductor physics, Diode and its application, voltage and current sources, dependent sources, voltage and current dividers,Kirchhoff’s Current Law and Kirchhoff’s Voltage Law, superposition, Thevenin and Norton equivalent sources, linear and nonlinear circuit analysis. Power Transfer Theorem, Bipolar Junction Transistors (BJT), Field Effect Transistors (FET); amplifiers, amplifier circuit designs, Steady state circuit fundamentals, Filter circuit design, frequency response and Operational amplifiers; circuits and frequency response. Analog to Digital conversion, Digital to analog converter Digital logic components and circuits.</p>
                                    <p>When you have the brief knowledge of these concepts, industry experts will teach to build small electronics project. </p> 
                                    <p>Interested learners can do hobby projects using these concepts. Our experts will guide you throughout the project. </p>
                                </div><!-- end title -->
                                ...
                                <div class="course-table">
                                    <table class="table table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><i class="fa fa-play-circle"></i></td>
                                                <td>Lesson One - What is WordPress</td>
                                                <td>20 Min</td>
                                                <td><i class="fa fa-close"></i></td>
                                            </tr>
                                            <tr>
                                                <td><i class="fa fa-play-circle"></i></td>
                                                <td>Lesson Two - How to Use Plugins</td>
                                                <td>41 Min</td>
                                                <td><i class="fa fa-close"></i></td>
                                            </tr>
                                            <tr>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row course-list">
                            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 wow fadeIn">
                                <div class="video-wrapper course-widget clearfix">
                                    <div class="post-media">
                                        <div class="entry">
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 wow fadeIn">
                                <div class="video-wrapper course-widget clearfix">
                                    ...
                                    <div class="widget-title clearfix">
                                        <h3><a href="course-single.html">Internet Marketing</a></h3>
                                        <hr>
                                        <div class="bottom-line clearfix">
                                            <div class="pull-left">
                                                <a href="member-profile.html" class="readmore"><img src="upload/testi_02.png" class="img-circle" alt="">Patrick Jane</a>
                                            </div>

                                            <div class="pull-right">
                                                <a href="course-single.html" class="btn btn-sm btn-inverse">$19.00</a>
                                            </div>
                                        </div><!-- end bottom -->
                                    </div><!-- end title -->
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 wow fadeIn">
                                <div class="video-wrapper course-widget clearfix">
                                    ...
                                    <div class="widget-title clearfix">
                                        <h3><a href="course-single.html">SEO Strategy</a></h3>
                                        <hr>
                                        <div class="bottom-line clearfix">
                                            <div class="pull-left">
                                                <a href="member-profile.html" class="readmore"><img src="upload/testi_03.png" class="img-circle" alt="">Amanda</a>
                                            </div>

                                            <div class="pull-right">
                                                <a href="course-single.html" class="btn btn-sm btn-inverse">$83.00</a>
                                            </div>
                                        </div><!-- end bottom -->
                                    </div><!-- end title -->
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-12 col-xs-12 wow fadeIn">
                                <div class="video-wrapper course-widget clearfix">
                                    <div class="post-media">
                                        <div class="entry">
                                            <img src="upload/course_09.jpg" alt="" class="img-responsive">
                                            <div class="magnifier">
                                                <div class="magni-desc">
                                                    <a class="secondicon" href="course-single.html"> <span class="oi" data-glyph="link-intact" title="Read More" aria-hidden="false"></span></a>
                                                </div><!-- end team-desc -->
                                    ...
                                    <div class="widget-title clearfix">
                                        <h3><a href="course-single.html">Learn API Development </a></h3>
                                        <hr>
                                        <div class="bottom-line clearfix">
                                            <div class="pull-left">
                                                <a href="member-profile.html" class="readmore"><img src="upload/testi_03.png" class="img-circle" alt="">Amanda</a>
