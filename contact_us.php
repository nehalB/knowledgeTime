                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                <label class="sr-only" for="contact-occupation">Occupation</label>
                                <input type="text" name="occupation" placeholder="Occupation..." class="contact-occupation form-control" id="contact-occupation">
                              </div>
                              <div class="form-group">
